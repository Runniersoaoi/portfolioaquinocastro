...
const defaultTexts = {
  en: {
    ...
    workCardThirtyTitle: "Recipe Web",
    workCardThirtyText: "Recipe application using TheMealDb",
    workBtnCode: "Code",
    workBtnDemo: "Demo",
  ...
  es: {
    ...
    workCardThirtyTitle: "Web de recetas",
    workCardThirtyText: "Usando TheMealDb API",
    workBtnCode: "Código",
    workBtnDemo: "Demo",
    workBtnComing: "Coming soon...",
    ...
    controlFormMaxLengthName:
      "Este campo puede tener como máximo 100 caracteres",
    controlFormEmail: "Este email es inválido",
    controlFormMinLengthMessage:
      "Este campo puede tener como mínimo 10 caracteres",
    controlFormMaxLengthMessage:
      "Este campo puede tener como máximo 500 caracteres",
  },
};
...
const LenguageProvider = ({ children }) => {
  ...
  return (
    <LenguageContext.Provider value={{ texts, lenguage, handleLenguage }}>
      {children}
